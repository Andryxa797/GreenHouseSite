        ...
        if self.request.user.is_authenticated:
            ...
            for owner in owners:
                if str(owner.owner_name) == self.kwargs['owner_name']:
                    ...
                    owner_avatar.append(get_owner.profile.avatar.url)
                    for item in data:
                        temp_greenhouse_upstairs.append(int(item.temp_greenhouse_upstairs))
                        temp_greenhouse_downstairs.append(int(item.temp_greenhouse_downstairs))
                        temp_greenhouse_in_ground.append(int(item.temp_greenhouse_in_ground))
                        temp_street.append(int(item.temp_street))
                        humidity_greenhouse.append(int(item.humidity_greenhouse))
                        humidity_greenhouse_in_ground.append(int(item.humidity_greenhouse_in_ground))
